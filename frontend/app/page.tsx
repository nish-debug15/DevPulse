...
export default function LandingPage() {
  return (
    <main className="flex min-h-screen flex-col items-center justify-center bg-zinc-950 px-4 text-zinc-50">
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-zinc-900 via-zinc-950 to-zinc-950 -z-10 opacity-70 pointer-events-none" />
      ...
      <Card className="w-full max-w-md border-zinc-800 bg-zinc-900/50 backdrop-blur-md text-zinc-50 shadow-2xl">
        ...
        <CardContent className="space-y-4">
          <a
            href="/api/auth/login"
            className="group/button inline-flex w-full h-11 shrink-0 items-center justify-center rounded-lg bg-zinc-50 text-zinc-950 font-mono hover:bg-zinc-200 font-semibold text-sm tracking-sm transition-all duration-150 cursor-pointer"
          >
